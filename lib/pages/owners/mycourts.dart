...
//         var availableDaysAndSlots = data['availableDaysAndSlots'] as List<dynamic>;

//         for (var slot in availableDaysAndSlots) {
//           // Since Firestore stores 'date' as a string, directly use it.
//           String formattedDate = slot['date'] ?? 'Unknown Date';
//           String formattedTime = slot['time'] ?? 'Unknown Time';
...
//     setState(() {
//   courts = formattedData; // ✅ No type conflict
//   isLoading = false;
// });


//     print(courts); // Debugging: Check formatted output
//   } catch (e) {
//     print('Error fetching courts: $e');
//     setState(() {
//       isLoading = false;
