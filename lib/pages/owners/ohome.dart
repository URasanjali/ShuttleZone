...
// import 'package:shuttlezone/pages/owners/mycourts.dart';

// import 'package:shuttlezone/Pages/notificationpage.dart';
// import 'package:shuttlezone/pages/courtdetails';
...
//   // Check if the user exists in Firestore and add if necessary
...
//   //       // Do not add a default court here anymore
//   //       print("User added to Firestore without default court.");
//   //     }
//   //   } catch (e) {
//   //     print("Error adding user to Firestore: $e");
//   //     rethrow; // Add a throw to ensure the method doesn't complete normally
//   //   }
//   // }
...
//                 ? NetworkImage(user!.photoURL!) // Use Firebase photoURL if available
//                 : const AssetImage('assets/profile_image.jpeg') as ImageProvider, // Fallback to local image
//           ),
//         ),
//         title: Text(
...
//                   onPressed: () {
//                     Navigator.push(
//                         context, MaterialPageRoute(builder: (context) => FilterScreen(onFiltersApplied: (filters) {  }, courtsData: [],)));
//                   },
...
//                             final imageUrl = court['image'] ?? 'https://example.com/default-image.jpg';
//                             return CourtCard(
//                               name: court['name'],
//                               District: court['District'],
//                               image: imageUrl, // Ensure a valid image URL is passed here
//                               userId: court['userId'],
...
//                 context,
//                 MaterialPageRoute(
//                   builder: (context) => MyCourtsScreen(
//                     authToken: authToken,  // Passing the authToken
//                     userId: user?.uid ?? '',  // Ensure that user?.uid is passed, fallback to empty string if null
//                   ),
//                 ),
//               );
...
//                   const SnackBar(
//                     content: Text(
//                         "Error: Unable to retrieve authentication token. Please try again."),
//                   ),
//                 );
//               }
//               break;
...
//                 courtId: courtId,         // Pass actual courtId
//                 courtDistrict: courtDistrict, name: '', District: '', image: '', courtName: '', // Pass the location
//               ),
//             ),
//           );
//         },
//         child: Container(
//           height: 300, // Adjust the height here (you can change this value)
//           child: Column(
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               ClipRRect(
...
//                           userId: userId,           // Pass actual userId
//                           courtId: courtId,         // Pass actual courtId
//                           courtDistrict: courtDistrict, name: '', Distric: '', image: '', courtName: '', // Pass the location
//                         ),
//                       ),
//                     );
//                   },
...
//                     backgroundColor: const Color(0xFF1B7340), // Custom button color
//                     shape: RoundedRectangleBorder(
//                       borderRadius: BorderRadius.circular(5),
//                     ),
//                   ),
//                 ),
//               ),
//               const SizedBox(height: 10), // Additional space at the bottom if needed
//             ],
//           ),
//         ),
//       ),
...
class _Ohome extends State<Ohome> {
  ...
  Future<void> fetchAllCourts() async {
    try {
      ...
      // Iterate through each court owner to fetch their courts
      for (var userDoc in usersSnapshot.docs) {
        String userId = userDoc.id;
          ...
          child: CircleAvatar(
            backgroundImage: user?.photoURL != null
                ...
                : const AssetImage('assets/profile_image.jpeg')
                    as ImageProvider, // Fallback to local image
          ),
        ),
        title: Text(
          "Hi, ${user?.displayName ?? 'User'}",
